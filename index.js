...
let baseDir = global.ihrissitepath
...
var extensions  = ['.js','.json','.coffee', '.html'];

// SCANNING THE FOLDERS AS SOON AS THIS FILE LOADS
let scanResults = {}
scanResults.core = scanner.scan(global.ihriscorepath, extensions);
scanResults.site = scanner.scan(global.ihrissitepath, extensions);
...
module.exports = ihrissmartrequire;
